...
# Repositories
repo --name=CentOS6-Base --baseurl=http://mirror.centos.org/centos/6.8/os/x86_64/
repo --name=CentOS6-Updates --baseurl=http://mirror.centos.org/centos/6.8/updates/x86_64/
